...
SECRET_KEY = 'django-insecure-12q3vz!#^0yp^d)rb0(paj_y6e2l_9mj2&xuf=@^4)+di%c)t('
...
REST_FRAMEWORK= {
    'DEFAULT_AUTHENTIFICATION_CLASSES' : [
        'rest_framework.autentification.TokenAuthentification',
    ],
...
# Manejo en setting la subida de archivos
MEDIA_URL = '/media/'
